...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		//this is my implementation for the finding the degree sequence
		List<Integer>degreeSequence = new ArrayList<Integer>();				
		for(int i = 0; i<getNumVertices();i++){
			degreeSequence.add(getNeighbors(i).size()+getInNeighbors(i).size());
		}	
		//now we have to sort this map based on Values	
		degreeSequence.sort(new GraphDegreeComparator());
